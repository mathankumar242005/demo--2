...
import { Check, Truck, Box, CreditCard, Wallet, BadgeDollarSign, Sparkles, Loader2, RotateCcw, ShoppingBag } from 'lucide-react';
            ...
            <div className="grid grid-cols-2 gap-4">
              {product.colors.map((color) => (
                <button
                  ...
                  className={`p-4 rounded-xl border flex flex-col items-center justify-center space-y-2 transition-all ${selectedColor?.name === color.name
            ...
            <div className="space-y-4">
              {product.storageOptions.map((storage) => (
                <button
                  ...
                  className={`w-full p-6 rounded-xl border flex justify-between items-center transition-all ${selectedStorage?.size === storage.size
                      ? 'border-blue-600 ring-1 ring-blue-600 bg-white'
          ...
          <div className="bg-gray-50 p-6 md:p-8 rounded-2xl space-y-6">
            ...
            <div className="pt-6 border-t border-gray-200">
              ...
              <div className="flex flex-col gap-3">
                <button
                  onClick={async () => {
                    if (!selectedColor || !selectedStorage || addingToCart) return;
                  ...
                  className={`px-8 py-3 rounded-full text-lg transition-colors w-full font-medium flex items-center justify-center gap-2 ${addedToCart
